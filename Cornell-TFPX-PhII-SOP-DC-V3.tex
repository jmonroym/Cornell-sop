...
\date{\today}
\author{M.Acero, T.Babenko, A.Daoud, J.Monroy}
...
\end{center}
    \begin{itemize}
        ...
        \item Small scooping tools for epoxy removal from holes
...
%    \begin{itemize}[leftmargin=*]
    ...
    \begin{figure}[H]
        ...
        \label{JigAlignment}
    \end{figure}
    \item Connect both labeled vacuum lines to their corresponding bottom jig.
...
%    \begin{itemize}[leftmargin=*]
        ...
        A calculator has been set up \href{https://cornellprod.sharepoint.com/:x:/r/sites/TFPXDeemanufacturing/_layouts/15/Doc.aspx?sourcedoc=%7B1955F9BA-B34C-40AF-83B5-E2F571FD91B1%7D&file=Epoxy%20mixing%20calculator.xlsx&action=default&mobileredirect=true}{here} in case a different amount of epoxy is desired. 80g of epoxy is used as reference in the following.
            ...
            \end{figure}
        \end{center}
        \item Place the first beaker (Beaker \#1) on the scale and zero the scale. Add 18.5 of Part A using one side of the Popsicle stick. Remove the beaker from the scale temporarily.
        \item Place the second beaker (Beaker \#2) onto the scale and zero the scale again. Add ~19.2g of EA9396 Part A into beaker \#2 on the scale using the same stick.
        \item Using a clean popsicle stick, place ~5.8g Part B into beaker \#2 then mix immediately. \textbf{Take note of the time at which the mixing began.}
        ...
        \item Press the green start button on the centrifuge and run for 30 seconds. Ensure no bubbles remain. If so, repeat centrifuging.
        \item Place beaker \#1 back onto the scale 
        \item Zero the scale again. Add 5.5g of Part B using the other side of the stick.    
        \item Add 56g of diamond powder and mix until a uniform grayish-green consistency is achieved.  \textbf{Also take note at this time which the doped epoxy is mixed.}
        ...
        \item Pour 45g of the centrifuged doped-epoxy back into beaker \#1 for spreading along the carbon foam of CFF\_B
        ...
        \item Take both the plain and doped epoxy filled syringes along with beaker \#1 holding the extra doped epoxy to clean room. Pass them to Person 1.
        \item Get dressed to get into the clean room   
%    \end{itemize}
    %Evaporator and inserts installation
%    \begin{itemize}
        \item Prepare inserts and Evaporator.
        \item \textbf{[Epoxy Spreading]} While deposition for CFF\_A is running, remove CFF\_B from the stand and bring it to a working table. Place the flower pattern cover piece over the CFF\_B flower pattern grooves. Use the extra container of doped epoxy and scrape/spread it across the carbon fiber surface of CFF\_B with a paintbrush. 
...
\begin{figure}[H]
    \centering
    \includegraphics[angle=90, width=0.5\linewidth]{img2/FPAT_Cover.png}
    \caption{Flower Pattern Cover used to protect the flower pattern grooves from getting clogged with epoxy during spreading of the doped epoxy on CFF\_B. Spatula/Scooping tool also included in image.}
    \label{FPATcover}
\end{figure}
        \item Return CFF\_B to the stand after the depositions on CFF\_A are completed, BEFORE the start of CFF\_B depositions
