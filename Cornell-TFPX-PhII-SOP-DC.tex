...
%    \begin{itemize}[leftmargin=*]
    ...
    \item Open LabView control software ``\textbf{put the path to the program here}''. Make sure it is opened with Labview 2024.
    ...
    \item Run the control software \textbf{Program name here} and provide the information required:
    \begin{enumerate}
        \item Part numbers.
    ...
    \item Put a rubber beaker on the scale and tare. Pour XXX g of Part A EA9396 epoxy in the beaker. Tare it again. Pour XXX g of part B EA9396 epoxy. Mix thoroughly for 2 minutes.   
...
%    \begin{itemize}[leftmargin=*]
        ...
        \item Run the calibration program in Motion Composer to set the correct pressure for epoxy deposition. \textbf{not sure which program is this??}.
...
Find the report at XXXXXXXXXX path to report. Write an ELog entry or upload the report to the appropriate DataBase.  
