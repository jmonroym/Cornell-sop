...
%    \begin{itemize}[leftmargin=*]
    ...
    \item Make sure that the NPAC is on, and make sure in Motion Composer the Gantry is connected (click the plug with a plus / the swirling arrows to reconnect)
